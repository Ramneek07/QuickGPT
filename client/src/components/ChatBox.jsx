    ...
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
      ...
      <div ref={containerRef} className="flex-1 mb-5 overflow-y-scroll">
        {messages.length === 0 && (
          ...
          <img alt='' className="w-full max-w-56 sm:max-w-68" 
      ...
      dark:border-[#80609F]/30 rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center">
        ...
        <input onChange={(e)=>setPrompt(e.target.value)} value={prompt} placeholder="Type your prompt here..." 
        className="flex-1 w-full text-sm outline-none " type="text" required />
