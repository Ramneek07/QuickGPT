...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-1 false
    ${!isMenuOpen && 'max-md:-translate-x-full'}`}>
        ...
        <img className="w-4 not-dark:invert" alt='' src= {assets.search_icon} />
        <input placeholder="Search conversations" className="text-xs placeholder:text-gray-400 outline-none" 
        ...
        dark:border-white/15 rounded-md">
            ...
            <div className="flex items-center gap-2 text-sm">
                <img className="w-4 not-dark:invert" alt='' src={assets.theme_icon} />
                <p>Dark Mode</p>
            </div>
